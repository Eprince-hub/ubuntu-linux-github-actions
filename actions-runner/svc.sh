...
SVC_NAME="actions.runner.Eprince-hub-ubuntu-linux-github-actions.Victors-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Eprince-hub-ubuntu-linux-github-actions.Victors-Air)"
